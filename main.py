...
import hirschbergLocalAlignment, utility, linearSpaceCounting, tracebakAll
...
def compute():
    ...
    tracebakAll.list.clear()
    tracebakAll.local_align(sequence1, sequence2, delta)
    return render_template('index.html', local_alignment=local_alignment, best_score=best_score, num_of_alignment=num_of_alignment, all_alignments=tracebakAll.list)